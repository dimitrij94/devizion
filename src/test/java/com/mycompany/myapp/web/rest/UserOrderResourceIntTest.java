...
public class UserOrderResourceIntTest {
    ...
    private static final String DEFAULT_CROPED_URI = "AAAAAAAAAA";
    private static final String UPDATED_CROPED_URI = "BBBBBBBBBB";
    ...
    public void createUserOrder() throws Exception {
        ...
        assertThat(testUserOrder.getCropedUri()).isEqualTo(DEFAULT_CROPED_URI);
    ...
    public void getAllUserOrders() throws Exception {
        ...
        restUserOrderMockMvc.perform(get("/api/user-orders?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cropedUri").value(hasItem(DEFAULT_CROPED_URI.toString())))
    ...
    public void getUserOrder() throws Exception {
        ...
        restUserOrderMockMvc.perform(get("/api/user-orders/{id}", userOrder.getId()))
            ...
            .andExpect(jsonPath("$.cropedUri").value(DEFAULT_CROPED_URI.toString()))
    ...
    public void updateUserOrder() throws Exception {
        ...
        assertThat(testUserOrder.getCropedUri()).isEqualTo(UPDATED_CROPED_URI);
