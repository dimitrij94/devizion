...
public class ProductResourceIntTest {
    ...
    private static final String DEFAULT_PRODUCT_IMAGE_URI = "AAAAAAAAAA";
    private static final String UPDATED_PRODUCT_IMAGE_URI = "BBBBBBBBBB";

    private static final String DEFAULT_CROPPED_IMAGE_URI = "AAAAAAAAAA";
    private static final String UPDATED_CROPPED_IMAGE_URI = "BBBBBBBBBB";

    private static final Float DEFAULT_PRODUCT_SELF_COST = 1F;
    private static final Float UPDATED_PRODUCT_SELF_COST = 2F;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .productImageUri(DEFAULT_PRODUCT_IMAGE_URI)
            .croppedImageUri(DEFAULT_CROPPED_IMAGE_URI)
            .productSelfCost(DEFAULT_PRODUCT_SELF_COST);
        return product;
    }
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getProductImageUri()).isEqualTo(DEFAULT_PRODUCT_IMAGE_URI);
        assertThat(testProduct.getCroppedImageUri()).isEqualTo(DEFAULT_CROPPED_IMAGE_URI);
        assertThat(testProduct.getProductSelfCost()).isEqualTo(DEFAULT_PRODUCT_SELF_COST);
    }
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].productImageUri").value(hasItem(DEFAULT_PRODUCT_IMAGE_URI.toString())))
            .andExpect(jsonPath("$.[*].croppedImageUri").value(hasItem(DEFAULT_CROPPED_IMAGE_URI.toString())))
            .andExpect(jsonPath("$.[*].productSelfCost").value(hasItem(DEFAULT_PRODUCT_SELF_COST.doubleValue())));
    }
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.productImageUri").value(DEFAULT_PRODUCT_IMAGE_URI.toString()))
            .andExpect(jsonPath("$.croppedImageUri").value(DEFAULT_CROPPED_IMAGE_URI.toString()))
            .andExpect(jsonPath("$.productSelfCost").value(DEFAULT_PRODUCT_SELF_COST.doubleValue()));
    }
    ...
    public void updateProduct() throws Exception {
        ...
        updatedProduct
            ...
            .productImageUri(UPDATED_PRODUCT_IMAGE_URI)
            .croppedImageUri(UPDATED_CROPPED_IMAGE_URI)
            .productSelfCost(UPDATED_PRODUCT_SELF_COST);
        ...
        assertThat(testProduct.getProductImageUri()).isEqualTo(UPDATED_PRODUCT_IMAGE_URI);
        assertThat(testProduct.getCroppedImageUri()).isEqualTo(UPDATED_CROPPED_IMAGE_URI);
        assertThat(testProduct.getProductSelfCost()).isEqualTo(UPDATED_PRODUCT_SELF_COST);
    }
