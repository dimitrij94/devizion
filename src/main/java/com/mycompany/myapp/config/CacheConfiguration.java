...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.UserOrder.class.getName() + ".orderedProducts", jcacheConfiguration);
            ...
            cm.createCache(com.mycompany.myapp.domain.Product.class.getName() + ".userOrders", jcacheConfiguration);
            ...
            cm.createCache(com.mycompany.myapp.domain.Product.class.getName() + ".portfolioEntries", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.PortfolioEntry.class.getName(), jcacheConfiguration);
