...
var UserOrderDialogComponent = (function () {
    function UserOrderDialogComponent(activeModal, jhiLanguageService, alertService, userOrderService, productService, custumerService, eventManager) {
    ...
    UserOrderDialogComponent.prototype.ngOnInit = function () {
        ...
        this.productService.query().subscribe(function (res) { _this.products = res.json(); }, function (res) { return _this.onError(res.json()); });
        this.custumerService.query().subscribe(function (res) { _this.custumers = res.json(); }, function (res) { return _this.onError(res.json()); });
    };
