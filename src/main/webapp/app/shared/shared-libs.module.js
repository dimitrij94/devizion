...
var DevizionSharedLibsModule = (function () {
    function DevizionSharedLibsModule() {
    }
    return DevizionSharedLibsModule;
}());
DevizionSharedLibsModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.DevizionSharedLibsModule = DevizionSharedLibsModule;
