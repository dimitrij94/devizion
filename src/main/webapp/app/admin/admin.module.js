...
var _1 = require("./");
var DevizionAdminModule = (function () {
    function DevizionAdminModule() {
    }
    return DevizionAdminModule;
}());
DevizionAdminModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.DevizionAdminModule = DevizionAdminModule;
