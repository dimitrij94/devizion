...
var _1 = require("./");
var DevizionAccountModule = (function () {
    function DevizionAccountModule() {
    }
    return DevizionAccountModule;
}());
DevizionAccountModule = __decorate([
    core_1.NgModule({
        imports: [
...
exports.DevizionAccountModule = DevizionAccountModule;
